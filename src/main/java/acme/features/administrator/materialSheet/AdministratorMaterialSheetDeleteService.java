...
@Service
public class AdministratorMaterialSheetDeleteService implements AbstractDeleteService<Administrator, MaterialSheet> {
	...
	@Override
	public void delete(final Request<MaterialSheet> request, final MaterialSheet entity) {
		assert request != null;
		assert entity != null;
