...
<acme:form  readonly="true">
	...
	<acme:form-url code="authenticated.toolSheet.form.label.providerHomePage" path="providerHomePage"/>
	<acme:form-moment code="authenticated.toolSheet.form.label.rating" path="rating"/>
